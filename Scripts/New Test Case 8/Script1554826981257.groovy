...
WebUI.click(findTestObject('Page_ng nhp  Sch Mm/span_Google_fa fa-google'))
...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/a_Delete'))

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/button_Confirm'))
