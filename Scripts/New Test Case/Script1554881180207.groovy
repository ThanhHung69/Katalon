...
WebUI.setText(findTestObject('Page_ng nhp  Sch Mm/input_a ch email_useremail'), 'thanhhungsky98@gmail.com')

WebUI.setEncryptedText(findTestObject('Page_ng nhp  Sch Mm/input_Mt khu_userpassword'), '+4Wj5QjyFPcebtHymcjpcg==')
...
WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/i_Lm c bi_fa fa-users'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_Hc liu - Sch Mm/input__btn btn-primary'))

WebUI.verifyElementText(findTestObject('Page_Hc liu - Sch Mm/div_Trng ny khng c  trng'), 'Trường này không được để trống')
