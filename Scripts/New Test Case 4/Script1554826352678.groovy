...
WebUI.setText(findTestObject('Object Repository/Page_Hc liu - Sch Mm/textarea_List Emails (mi email trn 1 dng)_form-control ng-untouched ng-dirty ng-valid'), 
    'dotam1306@gmail.com')
